    ...
    <main className="dashboard-page">
      ...
      <section className="dashboard-welcome">
        ...
        <div className="dashboard-actions">
          <Link to="/skills" className="dashboard-primary-button">
            Find a Skill
          </Link>

          <Link to="/skills/new" className="dashboard-secondary-button">
            Offer a Skill
          </Link>
        </div>
      </section>
      ...
      <section className="dashboard-section">
        <div className="dashboard-section-heading dashboard-heading-row">
          ...
          <Link to="/skills" className="dashboard-view-all">
            View All
          </Link>
        </div>
        ...
        <div className="dashboard-skill-grid">
          <article className="dashboard-skill-card">
            <div className="dashboard-skill-placeholder">JS</div>
            <span>TECHNOLOGY</span>
            <h3>JavaScript Programming</h3>
            <p>By David A.</p>
            <div className="dashboard-skill-bottom">
              <strong>★ 9/10</strong>
              <button type="button" aria-label="Save JavaScript Programming">
                ♡
              </button>
            </div>
            <Link to="/skills" className="dashboard-card-link">
              View Skill
            </Link>
          </article>

          <article className="dashboard-skill-card">
            <div className="dashboard-skill-placeholder">UI</div>
            <span>DESIGN</span>
            <h3>UI Design</h3>
            <p>By Sara M.</p>
            <div className="dashboard-skill-bottom">
              <strong>★ 9/10</strong>
              <button type="button" aria-label="Save UI Design">
                ♡
              </button>
            </div>
            <Link to="/skills" className="dashboard-card-link">
          ...
          <article className="dashboard-skill-card">
            <div className="dashboard-skill-placeholder">PH</div>
            <span>CREATIVE</span>
            <h3>Photography</h3>
            <p>By Noor A.</p>
            <div className="dashboard-skill-bottom">
              <strong>★ 8/10</strong>
              <button type="button" aria-label="Save Photography">
                ♡
              </button>
            </div>
            <Link to="/skills" className="dashboard-card-link">
          ...
          <article className="dashboard-skill-card">
            <div className="dashboard-skill-placeholder">DM</div>
            <span>BUSINESS</span>
            ...
            <div className="dashboard-skill-bottom">
              ...
              <button
                type="button"
                aria-label="Save Digital Marketing"
              >
                ♡
              </button>
            </div>
      ...
      <section className="dashboard-section">
        <div className="dashboard-section-heading dashboard-heading-row">
          ...
          <Link to="/swaps" className="dashboard-view-all">
            View All
          </Link>
        </div>
      ...
      <section className="dashboard-section">
        <div className="dashboard-section-heading dashboard-heading-row">
          ...
          <Link to="/community" className="dashboard-view-all">
            View Community
          </Link>
        </div>
        ...
        <div className="dashboard-community-grid">
          <article className="dashboard-person-card">
            <div className="dashboard-avatar">DA</div>
            <h3>David A.</h3>
          ...
          <article className="dashboard-person-card">
            <div className="dashboard-avatar">NA</div>
            <h3>Noor A.</h3>
